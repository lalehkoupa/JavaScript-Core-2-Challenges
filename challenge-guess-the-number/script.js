...
let count = 7;
const outputTriesEl = document.querySelector(".Tries-output");
const outputFinalEl = document.querySelector(".final-output");
outputFinalEl.innerHTML = "Guess a number between 1 and 100";
outputTriesEl.innerHTML = `Number of Tries: ${count}`;

function guessNumber() {
  //Collect input from the user
  const guessNum = Number(document.querySelector(".inputs-Values").value);
